...
<p align="center"><em>Telecommunications Engineer | ITS & Systems | Smart Infrastructure</em></p>
...
- Supervisão da implementação de sistemas ITS e de controle de tráfego.  
- Inspeções em campo para garantir conformidade técnica e regulatória.  
- Revisão e aprovação de materiais (PAMs).  
- Produção de relatórios técnicos para suporte à tomada de decisão do cliente.  
